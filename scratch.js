...
//strategy(title = "Mex Maker", shorttitle = "Mex Maker", overlay = true, 
//  pyramiding = 0, default_qty_type = strategy.percent_of_equity, default_qty_value = 10, calc_on_every_tick=true)

study(title="Mex Maker", overlay = true)
...
//alertcondition(true, title='Alert on Green Bar', message='Green Bar!')
alertcondition(longCond, title='Go Long', message='e=bitmex-testnet s=xbtusd b=long l=10 q=100')
plotshape(longCond, location=location.belowbar, text="LONG IT")
alertcondition(shortCond, title='Go Short', message='e=bitmex-testnet s=xbtusd b=short l=10 q=100')
plotshape(shortCond, location=location.abovebar, text="SHORT IT")
alertcondition(shortCond==true and tradeType=="LONG", title='Close Long', message='e=bitmex-testnet s=xbtusd b=short l=10 q=200')
plotshape(shortCond==true and tradeType=="LONG", location=location.abovebar, text="CLOSE SHORT!")
alertcondition(longCond==true and tradeType=="SHORT", title='Close Short', message='e=bitmex-testnet s=xbtusd b=long l=10 q=200')
plotshape(longCond==true and tradeType=="SHORT", location=location.belowbar, text="CLOSE LONG!")
